        ...
        <View style={styles.container}>
            <View style={styles.wrapper}>
                <View style={styles.cardContainer}>
                    ...
                    <TouchableOpacity style={styles.wrapCard} onPress={() => navigation.navigate('CancelAccessCard')}>
                        <View style={styles.center}>
                ...
                <TouchableOpacity style={styles.residentCard} onPress={() => navigation.navigate('ReissueAccessCard')}>
                    <View style={styles.center}>
